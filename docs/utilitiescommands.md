...
| /bugreport        | /bugreport [title] [description] [Option: imgurl] | Have you encountered a bug? Use this command to send a bug report directly to the developer. | N/A | N/A |
